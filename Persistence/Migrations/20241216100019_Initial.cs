        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration = table.Column<TimeSpan>(type: "interval", maxLength: 50, nullable: false),
                    SpecialistEntityId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Services", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Services_Specialists_SpecialistEntityId",
                        column: x => x.SpecialistEntityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialistEntityId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Specialties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Specialties_Specialists_SpecialistEntityId",
                        column: x => x.SpecialistEntityId,
                        principalTable: "Specialists",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Review_Specialists_SpecialistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_SpecialistEntityId",
                table: "Services",
                column: "SpecialistEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Specialties_SpecialistEntityId",
                table: "Specialties",
                column: "SpecialistEntityId");
        }
